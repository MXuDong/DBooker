...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="jumbotron">
            ...
            <p class="lead">我的详细信息
                <button id="InforChange" type="button" class="btn btn-outline-primary float-right disabled"
                        onclick="InforChange_Click()">修改
                </button>
            </p>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input class="form-control" value="${requestScope.userSeinput}" id="P_UserSex"
                               onchange="InputChanged()"></input></td>
                </tr>
                <tr>
                    <td><p class="lead">用户真实姓名</p></td>
                    <td>:</td>
                    <td><input class="form-control" value="${requestScope.userTrueName}" id="P_TrueName"
                               onchange="InputChanged()"></input></td>
                </tr>
                <tr>
                    <td><p class="lead">用户签名</p></td>
                    <td>:</td>
                    <td><input class="form-control" value="${requestScope.userSign}" id="P_UserSign"
                               onchange="InputChanged()"></input></td>
                </tr>
                <tr>
                    <td><p class="lead">用户自述</p></td>
                    <td>:</td>
                    <td><input class="form-control" value="${requestScope.userDisc}" id="P_UserDisc"
                               onchange="InputChanged()"></input></td>
                </tr>
                <tr>
                    <td><p class="lead">联系电话</p></td>
                    <td>:</td>
                    <td><input class="form-control" value="${requestScope.userPhone}" type="number" id="P_UserPhone"
                               onchange="InputChanged()"></input></td>
                </tr>
                <tr>
                    <td><p class="lead">QQ</p></td>
                    <td>:</td>
                    <td><input class="form-control" value="${requestScope.userQQ}" type="number" id="P_UserQQ"
                               onchange="InputChanged()"></input></td>
                </tr>
                <tr>
                    <td><p class="lead">邮箱</p></td>
                    <td>:</td>
                    <td><input class="form-control" value="${requestScope.userEmail}" id="P_UserEmail"
                               onchange="InputChanged()"></input></td>
                </tr>
            </table>
        </div>
...
<script language="JavaScript">
    ...
    function InforChange_Click() {
        ...
        $("#InforChange").text("修改");
        $("#InforChange").addClass("disabled");

        // 绑定基本数据
        var userId = getUserIdInCookie();
        var userName = $("#P_UserName").text();
